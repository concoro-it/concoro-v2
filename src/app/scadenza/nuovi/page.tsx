    ...
    return (
        <div className="container max-w-container mx-auto px-4 py-8">
            <nav className="flex items-center gap-1.5 text-sm text-muted-foreground mb-6">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-foreground">Nuovi Arrivi</span>
            </nav>
            ...
            <div className="mb-8">
                ...
                <p className="text-muted-foreground mt-1">
                    {count} nuovi concorsi pubblicati negli ultimi 7 giorni.
                </p>
            </div>
            ...
            {count === 0 && (
                <div className="text-center py-12 border rounded-xl bg-muted/30">
                    <p className="text-muted-foreground">Nessun nuovo concorso pubblicato negli ultimi 7 giorni.</p>
                </div>
            )}
        </div>
    );
