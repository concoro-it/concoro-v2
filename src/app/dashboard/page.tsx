...
export const metadata: Metadata = { title: 'Dashboard | Concoro' };
        ...
        <div className="container max-w-container mx-auto px-4 py-8">
            ...
            <div className="flex items-start justify-between mb-8">
                ...
                <div className="flex gap-2">
                    <Link href="/impostazioni" className="p-2 border border-border rounded-lg hover:bg-secondary transition-colors">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
                <Link href="/dashboard/salvati" className="bg-white border border-border rounded-xl p-4 hover:border-primary/50 transition-colors block">
                ...
                <Link href="/dashboard/ricerche" className="bg-white border border-border rounded-xl p-4 hover:border-primary/50 transition-colors block">
            ...
            <div>
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/dashboard/salvati" className="text-sm text-primary hover:underline">Vedi tutti</Link>
                </div>
                {savedConcorsi.length > 0
                    ? <ConcorsoList concorsi={savedConcorsi.slice(0, 3)} />
                    : (
